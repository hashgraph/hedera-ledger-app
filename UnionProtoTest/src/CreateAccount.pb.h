...
/* Generated by nanopb-0.4.0-dev at Thu May  2 16:23:36 2019. */
...
/* Enum definitions */
typedef enum _HederaFunctionality {
    HederaFunctionality_NONE = 0,
    HederaFunctionality_CryptoTransfer = 1,
    HederaFunctionality_CryptoUpdate = 2,
    HederaFunctionality_CryptoDelete = 3,
    HederaFunctionality_CryptoAddClaim = 4,
    HederaFunctionality_CryptoDeleteClaim = 5,
    HederaFunctionality_ContractCall = 6,
    HederaFunctionality_ContractCreate = 7,
    HederaFunctionality_ContractUpdate = 8,
    HederaFunctionality_FileCreate = 9,
    HederaFunctionality_FileAppend = 10,
    HederaFunctionality_FileUpdate = 11,
    HederaFunctionality_FileDelete = 12,
    HederaFunctionality_CryptoGetAccountBalance = 13,
    HederaFunctionality_CryptoGetAccountRecords = 14,
    HederaFunctionality_CryptoGetInfo = 15,
    HederaFunctionality_ContractCallLocal = 16,
    HederaFunctionality_ContractGetInfo = 17,
    HederaFunctionality_ContractGetBytecode = 18,
    HederaFunctionality_GetBySolidityID = 19,
    HederaFunctionality_GetByKey = 20,
    HederaFunctionality_CryptoGetClaim = 21,
    HederaFunctionality_CryptoGetStakers = 22,
    HederaFunctionality_FileGetContents = 23,
    HederaFunctionality_FileGetInfo = 24,
    HederaFunctionality_TransactionGetRecord = 25,
    HederaFunctionality_ContractGetRecords = 26,
    HederaFunctionality_CryptoCreate = 27,
    HederaFunctionality_SystemDelete = 28,
    HederaFunctionality_SystemUndelete = 29,
    HederaFunctionality_ContractDelete = 30
} HederaFunctionality;
#define _HederaFunctionality_MIN HederaFunctionality_NONE
#define _HederaFunctionality_MAX HederaFunctionality_ContractDelete
#define _HederaFunctionality_ARRAYSIZE ((HederaFunctionality)(HederaFunctionality_ContractDelete+1))
...
#define TransactionFeeSchedule_init_default      {(HederaFunctionality)0, FeeData_init_default}
...
#define TransferList_init_default                {{{NULL}, NULL}}
#define CryptoTransferTransactionBody_init_default {TransferList_init_default}
#define TransactionBody_init_default             {TransactionID_init_default, AccountID_init_default, 0, Duration_init_default, 0, {{NULL}, NULL}, 0, {CryptoCreateTransactionBody_init_default}}
...
#define TransactionFeeSchedule_init_zero         {(HederaFunctionality)0, FeeData_init_zero}
...
#define TransferList_init_zero                   {{{NULL}, NULL}}
#define CryptoTransferTransactionBody_init_zero  {TransferList_init_zero}
#define TransactionBody_init_zero                {TransactionID_init_zero, AccountID_init_zero, 0, Duration_init_zero, 0, {{NULL}, NULL}, 0, {CryptoCreateTransactionBody_init_zero}}
...
#define TransactionFeeSchedule_hederaFunctionality_tag 1
...
/* TransferList_size depends on runtime parameters */
#define CryptoTransferTransactionBody_size       (6 + TransferList_size)
