...
const pb_field_t TransferList_fields[2] = {
    PB_FIELD(  1, MESSAGE , REPEATED, CALLBACK, FIRST, TransferList, accountAmounts, accountAmounts, &AccountAmount_fields),
    PB_LAST_FIELD
};
